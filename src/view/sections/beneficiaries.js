...
const Sections = {
    "involving": {
        ...
        advice: [
            ...
            m("ul", [
                m("li", `Workers could sit on a data advisory group, which could serve as an oversight body for the project;`),
                ...
                m("li", `Project champions could engage directly with their fellow workers about the project; `)
