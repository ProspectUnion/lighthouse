...
const Sections = {
    ...
    "mitigation": {
        ...
        advice: [
            ...
            m("p", `In addition, you should have a project or organisation-wide escalation policy for risks that are especially severe, or that are especially close to being realised. Especially for complex projects, consider requiring project teams to think through and track their own risks.`),
            ...
            m("p", [`If you are in the UK then you will need to consider whether a Data Protection Impact Asessment is needed `, m("a", {class:'link b', href:"https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/accountability-and-governance/data-protection-impact-assessments/"}, "you can find out more" ), ` from the UK Information Commissioner's Office.`])
