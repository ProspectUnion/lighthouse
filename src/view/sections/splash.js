...
const Splash = {
    view: (vnode)=>{
        return [
            m("p", `Welcome to Lighthouse, a purpose-made digital governance maturity test for trade unions.`),
            m("p", `This is a tool to help your union become more responsible stewards of data.  You’ll find a mix of guidance and quiz questions to help you better protect, manage, and harness data.`),
