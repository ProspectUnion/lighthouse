...
const Sections = {
    "practice": {
        ...
        checks: [
            ...
            "Our staff are regularly trained on data handling practices. This training is also part of employee onboarding.",
            "We regularly update our data handling practices as our work evolves, and/or to match changing best practice.",
        ...
        copy: [
            ...
            m("p", "This data may be sensitive. Data could describe people’s salaries, health issues, home addresses, or disputes with their manager, just to name a few. Because data is so easy to copy and transfer, it’s important that each of your project assets have someone who is responsible for stewarding, maintaining, and safeguarding them. In addition, consider whether your team has a baseline level of data competency and training. As more and more jobs involve data handling of some kind, having organisational standards for handling data is more and more important."),
        ],
        advice: [
            m("p", `Your digital assets are valuable, for your organisation and your members. Because they aren't physical objects, it's easy for digital assets to slip through the cracks and not have anyone take responsibility for them, or to delegate responsibility solely to an internal IT function. Avoid this trap.`),
            m("p", "Your project team need not all be technology experts, but they should have at least a basic understanding of how your project uses data, even if they don't handle it directly. A written data handling policy can help set baseline expectations for staff capacity, and provides a mechanism for your team to feedback on policies and processes that aren't working as intended."),
            m("p", "Some ways that you can help build a better data culture in your organisation are:"),
            m("ul", [
                m("li", `Including data responsibilities in job descriptions;`),
                m("li", `Incorporating data training into new employee onboarding;`),
                m("li", `Building data responsibilities into team objectives and organisational strategy;`),
    ...
    "protection": {
        ...
        advice: [
            ...
            m("p", [`You may find this `, m("a", {class:'link b', href:"https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/"}, "guide" ), ` to the General Data Protection Regulation  from the UK Information Commissioner's Office useful.`]),
            m("p", [`If you are in the UK you will also need to be aware of `, m("a", {class:'link b', href:"https://ico.org.uk/for-organisations/guide-to-data-protection/guide-to-the-general-data-protection-regulation-gdpr/lawful-basis-for-processing/special-category-data/"}, "special category data" ), ` which includes trade union membership.`]),
