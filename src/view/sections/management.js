...
const Sections = {
    ...
    "responsible": {
        ...
        copy: [
            ...
            m("p", "Ultimately, your project’s management is about more than just about assigning roles. At a deeper level, you’re building a sense of responsibility between your team and the workers you mean to help. Ensuring that a project’s management is accountable and trustworthy is ultimately up to you."),
        ],
        advice: [
